    ...
    <div
        class="divide-y divide-gray-100 overflow-hidden rounded-lg bg-white text-sm shadow ring-1 ring-black ring-opacity-5">
            ...
            <div class="group flex p-4 pr-6 focus-within:bg-gray-50 hover:bg-gray-50">
                ...
                <a href="#"
                    wire:click="update()"
                    class="ml-6 flex-none self-center rounded-md border border-gray-300 bg-white py-2 px-3 font-semibold text-gray-700 opacity-0 shadow-sm hover:bg-gray-50 focus:opacity-100 group-hover:opacity-100">Update<span
                        class="sr-only">Update</span></a>

                        {{-- Delete Button --}}
                <a href="#"
                    wire:click="delete( {{ $selected_blog_id }} )"
