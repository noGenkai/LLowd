{{-- The top DIV will have the toggle to open and close the section using the showBlogDetails Livewire's wire model.
The component will pull the blog data that was entered into the MySQL database by ID.
Attachments are that reference any blog-ids will also display here. --}}
        ...
        <div class="group flex p-4 pr-6 focus-within:bg-gray-50 hover:bg-gray-50">
            <div class="flex-auto">
                ...
                <div class="w-full p-4">
                    <div class="flex flex-col sm:flex-row justify-around justify-evenly h-40">
                    @foreach ($selected_blog_photos as $photo)

                        <div class="basis-1/3">
                            <img class="object-cover  h-50 w-50  mx-auto" src="{{ asset($photo->file_path) }}" alt="{{ $photo->file_name }}">
                        </div>
